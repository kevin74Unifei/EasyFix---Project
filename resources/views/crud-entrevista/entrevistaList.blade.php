            ...
            <tr>
                <th>
                    <a href="{{url("servico/show/".$f['ent_cod'])}}" class="list-group-item" style="height:100px;width:660px;">  
                        ...
                        @if($f['ent_cod_pres']==Auth::user()->id)
                        ...
                        @else
                        <a href="{{url("servico/att/".Auth::user()->id."/".$f['ent_cod'])}}" class="buttons_tools">
                            <span class="glyphicon glyphicon-arrow-up" style="padding: 4px;" aria-hidden="true"></span>Agendar Serviço</a>  
                        @endif
                    </a>
                </th>            
            </tr>
